...
class CompanyAddress
  ...
  def self.create(company_id:, zip:, street:, city:, state:)
    ...
    return "O cep é obrigatório" if new_address.zip.nil? || new_address.zip == ""
    return "O estado é obrigatório" if new_address.state.nil? || new_address.state == ""
    return "A cidade é obrigatória" if new_address.city.nil? || new_address.city == ""
    return "A rua é obrigatória" if new_address.street.nil? || new_address.street == ""
